...
<script
	src="<%=request.getContextPath()%>/assets/js/vendor/jquery-1.12.4.min.js"></script>
<!-- Popper js -->
<script
...
<!-- Meanmenu js -->
<script
	src="<%=request.getContextPath()%>/assets/js/jquery.meanmenu.min.js"></script>
<!-- Wow.min js -->
...
<!-- Imagesloaded js -->
<script
	src="<%=request.getContextPath()%>/assets/js/imagesloaded.pkgd.min.js"></script>
<!-- Mixitup js -->
<script
	src="<%=request.getContextPath()%>/assets/js/jquery.mixitup.min.js"></script>
<!-- Countdown -->
<script
...
<!-- Barrating -->
<script
	src="<%=request.getContextPath()%>/assets/js/jquery.barrating.min.js"></script>
<!-- Jquery-ui -->
<script src="<%=request.getContextPath()%>/assets/js/jquery-ui.min.js"></script>
<!-- Venobox -->
<script src="<%=request.getContextPath()%>/assets/js/venobox.min.js"></script>
<!-- Nice Select js -->
<script
	src="<%=request.getContextPath()%>/assets/js/jquery.nice-select.min.js"></script>
<!-- ScrollUp js -->
<script src="<%=request.getContextPath()%>/assets/js/scrollUp.min.js"></script>
<!-- Main/Activator js -->
