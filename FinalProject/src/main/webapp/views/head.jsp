...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/material-design-iconic-font.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" />
  <!-- Font Awesome Stars-->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/fontawesome-stars.css">
  <!-- Meanmenu CSS -->
  ...
  <!-- Venobox CSS -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/venobox.css">
  <!-- Nice Select CSS -->
