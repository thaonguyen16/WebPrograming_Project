  ...
  <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
    ...
    <div class="navbar-right ">
      ...
      <div class="search-form">
        <form action="${pageContext.request.contextPath}/Admin_Dashboard" method="get">
        ...
        <ul class="dropdown-menu dropdown-menu-search">
          <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/Admin_Dashboard">Morbid leo rises</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/Admin_Dashboard">Paribus ac facilitates in</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/Admin_Dashboard">Port ac consecrate ac</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/Admin_Dashboard">Vestibulum at eros</a>
          </li>
        </ul>
      </div>
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user-menu">
          <button class="dropdown-toggle nav-link" data-toggle="dropdown">
            <img src="<%= request.getContextPath() %>/assets/images/user/user-xs-01.jpg" class="user-image rounded-circle" alt="User Image" />
            <span class="d-none d-lg-inline-block">John Doe</span>
          </button>
          <ul class="dropdown-menu dropdown-menu-right">
            <li>
              <a class="dropdown-link-item" href="${pageContext.request.contextPath}/Admin_User_Profile">
                <i class="mdi mdi-account-outline"></i>
                <span class="nav-text">My Profile</span>
              </a>
            </li>
            <li>
              <a class="dropdown-link-item" href="${pageContext.request.contextPath}/Admin_Email_Inbox">
            ...
            <li>
              <a class="dropdown-link-item" href="${pageContext.request.contextPath}/Admin_User_Account_Setting">
