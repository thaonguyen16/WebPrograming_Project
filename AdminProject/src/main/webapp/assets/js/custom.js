...
$(document).ready(function () {
  ...
  if (countrySalesRange.length !== 0) {
    ...
    function cb1(start1, end1) {
      $("#country-sales-range .date-holder").html(
        start1.format("MMMM D, YYYY") + " - " + end1.format("MMMM D, YYYY")
      );
    }
  ...
  if (codeEditor) {
    var htmlCode = `<html style="color: green" lang="en">
  <!-- this is a comment -->
  <head>"
  ...
  function callToaster(positionClass) {
    ...
    toastr.success(toaster, "Successful!");
  }
