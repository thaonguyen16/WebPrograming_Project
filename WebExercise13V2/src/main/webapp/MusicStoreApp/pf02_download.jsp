...
<section class="home-section">
    <div class="text">
        ...
        <h2 class="text-logo" style="font-size: 3vw;">Paddlefoot - The Second CD</h2>
        <table class="container-table" style="margin-top:100px;width: 100%;border: 0px;margin-bottom: 50px">
            ...
            <tr style="background: white;height:50px;">
                <td>Neon Lights</td>
                <td>MP3</td>
                <td><a href="../musicStore/sound/${productCode}/neon.mp3" style="text-decoration: none;">Listen</a></td>
                <td>
                    <a href="../musicStore/sound/${productCode}/neon.mp3" style="text-decoration: none;" download>Download</a>
                </td>
            </tr>
            <tr style="background: white;height:50px;">
                <td>Tank Hill</td>
                <td>MP3</td>
                <td><a href="../musicStore/sound/${productCode}/tank.mp3" style="text-decoration: none;">Listen</a></td>
                <td>
                    <a href="../musicStore/sound/${productCode}/tank.mp3" style="text-decoration: none;" download>Download</a>
                </td>
            </tr>
