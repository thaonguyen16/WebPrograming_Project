...
<section class="home-section">
    <div class="text">
        ...
        <h2 class="text-logo" style="font-size: 3vw;">Joe Rut - Genuine Wood Grained Finish</h2>
        ...
        <table class="container-table" style="margin-top:100px;width: 100%;border: 0px;margin-bottom: 50px">
            ...
            <tr style="background: white;height:50px;">
                <td>Filter</td>
                <td>MP3</td>
                <td><a href="../musicStore/sound/${productCode}/filter.mp3" style="text-decoration: none;">Listen</a></td>
                <td>
                    <a href="../musicStore/sound/${productCode}/filter.mp3" style="text-decoration: none;" download>Download</a>
                </td>
            </tr>
            <tr style="background: white;height:50px;">
                <td>So Long Lazy Ray</td>
                <td>MP3</td>
                <td><a href="../musicStore/sound/${productCode}/so_long.mp3" style="text-decoration: none;">Listen</a></td>
                <td>
                    <a href="../musicStore/sound/${productCode}/so_long.mp3" style="text-decoration: none;" download>Download</a>
                </td>
            </tr>
