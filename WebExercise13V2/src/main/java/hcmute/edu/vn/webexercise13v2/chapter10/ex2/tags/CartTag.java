package hcmute.edu.vn.webexercise13v2.chapter10.ex2.tags;
...
import hcmute.edu.vn.webexercise13v2.chapter10.ex2.business.*;
...
public class CartTag extends BodyTagSupport {
    ...
    public int doStartTag() {
        Cart cart = (Cart) pageContext.findAttribute("cart1");
