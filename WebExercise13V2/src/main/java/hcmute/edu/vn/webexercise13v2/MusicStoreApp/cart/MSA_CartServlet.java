...
@WebServlet(name = "MACartServlet", value = "/MusicStoreApp/cart")
public class MSA_CartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        request.getRequestDispatcher("/MusicStoreApp/menu_cart.jsp").forward(request,response);
    }
    @Override
    protected void doPost(HttpServletRequest request,
        ...
        switch (action) {
            case "shop":
                url = "/MusicStoreApp/menu_cart.jsp";    // the "index" page
            ...
            case "cart":
                ...
                url = "/MusicStoreApp/cart.jsp";
                break;
            case "checkout":
                url = "/MusicStoreApp/checkout.jsp";
                break;
        }
