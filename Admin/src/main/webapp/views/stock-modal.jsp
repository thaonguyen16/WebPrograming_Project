<div class="modal fade modal-stock" id="modal-stock"
	aria-labelledby="modal-stock" aria-hidden="true">
					...
					<div class="row">
						<div class="col-lg-8">
							...
							<div class="form-group mb-5">
								<label for="new-product">Product Title</label> <input
									type="text" class="form-control" id="new-product"
							...
							<div class="product-type mb-3 ">
								<label class="d-block" for="sale-price">Product Type <i
									class="mdi mdi-help-circle-outline"></i>
								</label>
								<div>
									...
									<div
										...
										<input type="radio" id="customRadio1" name="customRadio"
											...
											class="custom-control-label" for="customRadio1">Physical
											Good</label>
									</div>
									...
									<div
										...
										<input type="radio" id="customRadio2" name="customRadio"
											...
											class="custom-control-label" for="customRadio2">Digital
											Good</label>
									</div>
									...
									<div
										...
										<input type="radio" id="customRadio3" name="customRadio"
											class="custom-control-input"> <label
											class="custom-control-label" for="customRadio3">Service</label>
									</div>
							...
							<div class="editor">
								...
								<div class="custom-control custom-checkbox d-inline-block mt-2">
									<input type="checkbox" class="custom-control-input"
										...
										for="customCheck2">Hide product from published site</label>
								</div>
						...
						<div class="col-lg-4">
							<div class="custom-file">
								<input type="file" class="custom-file-input" id="customFile"
									placeholder="please imgae here"> <span
									class="upload-image">Click here to <span
									class="text-primary">add product image.</span>
								</span>
							</div>
						</div>
					</div>
